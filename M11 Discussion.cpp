/*
M11 Discussion: Overloading and Templates
...
public:
    Character(string n, int l, string c) : name(n), level(l), {}

    // Templated function to display info
    template <typename characterInfo>
    void displayInfo(characterInfo primary_ability) {
        cout << "Name: " << name << endl;
        cout << "Level: " << level << endl;
        cout << "Class: " << class_name << endl;
        cout << "Primary Ability: " << primary_ability << endl;
    }
...
public:
    ...
    void displayInfo() {
        Character::displayInfo("Charisma");
    }
};
...
public:
    ...
    void displayInfo() {
        Character::displayInfo("Dexterity");
    }
};
